...
%>
  ...
  <urlPrefixes>
    ...
    <showHelpPage><c:url value="/main/showHelp.rdo?b=de"/></showHelpPage>
    ...
    <event>
      ...
      <updateStatusFromSearch><c:url value="/event/updateStatusFromSearch.do?b=de"/></updateStatusFromSearch>
